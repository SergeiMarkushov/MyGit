    ...
    protected void processMouseEvent(MouseEvent mouseEvent){
        ...
        if (mouseEvent.getButton() == MouseEvent.BUTTON1){
            ...
            if (field[i][j] == FIELD_EMPTY){
                ...
                if (res !=0){
                    if (res == FIELD_O * 3){
                        JOptionPane.showMessageDialog(this, "O are win", "Win!", JOptionPane.INFORMATION_MESSAGE);
                    }else if (res == FIELD_X *3){
                        JOptionPane.showMessageDialog(this, "X are win", "Win!", JOptionPane.INFORMATION_MESSAGE);
                    }else{
                        JOptionPane.showMessageDialog(this, "Nobody wins!", "NO WINNER!", JOptionPane.INFORMATION_MESSAGE);
                    }
                    initGAme();
                    repaint();
                }
